...
public class Assets {
	...
	public static final Texture slider = new Texture(
			Gdx.files.internal("menu/slider.png"));
	...
	static {
		...
		NormasByName.put("defaultNormal",
				new Texture(Gdx.files.internal("Normals/defaultNormal.png")));
		...
		NormasByName.put(
				"instructionsNormal",
				new Texture(Gdx.files
						.internal("Normals/instructionsNormal.png")));
		...
		NormasByName
				.put("pill_greenNormal",
						new Texture(Gdx.files
								.internal("Normals/pill_greenNormal.png")));
		NormasByName.put(
				"shield_bronzeNormal",
				new Texture(Gdx.files
						.internal("Normals/shield_bronzeNormal.png")));
