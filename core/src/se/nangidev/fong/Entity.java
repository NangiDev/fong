...
public class Entity implements Disposable {
	...
	private float x, y;
	private int ID;
	private se.nangidev.fong.EntityManager entityManager;

	public Entity(float x, float y, se.nangidev.fong.EntityManager entityManager) {
	...
	public void setEntityManager(se.nangidev.fong.EntityManager entityManager){
		this.entityManager = entityManager;
	}
