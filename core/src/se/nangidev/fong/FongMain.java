...
public class FongMain extends Game {
    ...
    public void readFromSavefile() {
        ...
        if (prefs.get().size() > 0) {
            ...
            prefs.putInteger("lightCount", lightCounter);
    ...
    private void createFont() {
        ...
        this.fontLarge = new BitmapFont(Gdx.files.internal("Fonts/font36.fnt"));
        this.fontLarge.getRegion().getTexture()
                .setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);

        this.fontMedium = new BitmapFont(Gdx.files.internal("Fonts/font24.fnt"));
        this.fontMedium.getRegion().getTexture()
                .setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);

        this.fontSmall = new BitmapFont(Gdx.files.internal("Fonts/font10.fnt"));
